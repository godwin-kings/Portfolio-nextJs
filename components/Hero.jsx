    ...
    >
      <div className="max-w-[1240px] px-4 mx-auto grid md:grid-cols-2  ">
        ...
        <div className=" flex flex-col justify-center items-center md:max-2xl:text-left p-8  dark:text-[#ecf0f3]">
          <h4 className=" text-pink-600 text-2xl py-2 tracking-widest md:text-left ">
            Hi! my name is
          </h4>
          <h1 className=" py-4 ">Bassey Godwin </h1>
          <h3 className=" text-2xl py-4">I am a full-stack Developer</h3>
          <h3>
            I am a full-stack developer specialize in building web application
            with exceptional design and digital experience. Currently, i am
            focused on building responsive full-stack web applications.
          </h3>
        </div>
      </div>
      {/*     SOCIAL */}
      <div className=" flex justify-center items-center dark:text-[#ecf0f3] gap-16 p-2  ">
        <FaLinkedin
          size={45}
