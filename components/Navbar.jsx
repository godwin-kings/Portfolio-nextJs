      ...
      >
        ...
        <div>
          <ul className="flex 2xs:max-md:hidden ">
            <Link href="/">
              <li className="p-4 dark:text-[#ecf0f3]">Home</li>
            </Link>
            <Link href="/#about">
              <li className="p-4 dark:text-[#ecf0f3]">About</li>
            </Link>
            <Link href="/#skills">
              <li className="p-4 dark:text-[#ecf0f3]">Skills</li>
            </Link>
            <Link href="/#project">
              <li className="p-4 dark:text-[#ecf0f3]">Project</li>
            </Link>
            <Link href="/#contact">
              <li className="p-4 dark:text-[#ecf0f3]">Contact</li>
            </Link>
            <li className="p-4 ">
              <form
                className="flex bg-white border-gray-500 border rounded-[15px] "
                action=""
              >
                <input
                ...
                <AiOutlineSearch
                  size={25}
                  className="dark:text-[#ecf0f3] justify-center  mr-2"
                />
              </form>
            </li>
            <li className="p-4">
              <BsFillMoonStarsFill
                className=" items-center dark:text-[#ecf0f3] "
        ...
        >
          <div className="Fixed left-0 top-0   pt-8 w-[60%] bg-white h-full px-4 border border-r-gray-200 z-10 ease-in-out duration-300 dark:bg-gray-900">
            <div className="flex justify-between">
              ...
              <div
                onClick={handleNav}
                className="z-10 rounded-full shadow-lg shadow-gray-400 p-2"
              >
                <MdOutlineRestaurantMenu
                  size={15}
                  className="dark:text-[#ecf0f3]"
                />
              </div>
            </div>
            <ul>
              <li className="my-5 ">
                <BsFillMoonStarsFill
                  className=" ml-3 dark:text-[#ecf0f3]"
                  size={25}
                  onClick={() => setDarkMode(!darkMode)}
                />
              </li>
              <form
                className="flex border-gray-500 border rounded-[15px] my-6 dark:bg-white"
                action=""
              >
                <input
                ...
                <AiOutlineSearch
                  size={35}
                  className=" items-end my-auto pr-2 cursor-pointer"
                />
              </form>
              <Link href="/">
